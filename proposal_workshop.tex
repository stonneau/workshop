...
\end{itemize}
%~ - selection of contact locations formalized as mixed-integer optimization
%~ - generation of whole-body movements in contact, in particular
%~ simultaneous optimization of kinematics and  central dynamics
%~ - planning and control of locomotion from dense perception \\ \\
